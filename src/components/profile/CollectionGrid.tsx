        ...
        {profileInfo.isOwnProfile && (
          <>
            ...
            <button
              onClick={(e) => {
                e.stopPropagation();
                setShowEditDialog(collection.id);
                setSelectedItems(collection.items);
              }}
              className="absolute top-2 right-2 p-2 bg-black/50 rounded-full text-white opacity-0 group-hover:opacity-100 hover:bg-black/70 transition-all duration-200 z-10"
            >
