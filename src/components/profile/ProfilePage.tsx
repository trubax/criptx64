...
import { collection, query, where, getDocs, writeBatch, arrayUnion, getCountFromServer } from 'firebase/firestore';
...
const ProfilePage = () => {
  ...
  const loadStats = async (userId: string) => {
    try {
      ...
      const videosSnapshot = await getCountFromServer(videosQuery);
      const videosCount = videosSnapshot.data().count;
